...
import com.example.solaprog.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng fianar = new LatLng(-21.454371, 47.083086);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(fianar, 18));
